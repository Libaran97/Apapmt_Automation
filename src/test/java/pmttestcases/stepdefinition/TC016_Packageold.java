...
public class TC016_Packageold extends Baseclass {
	...
	public void user_will_go_to_parts_page_and_search_for_a_partno() throws Throwable {
	    ...
	    try {
			//extent=setup();	
			test = extent.createTest(Feature.class, "PMT Parts Package Add, Edit and Delete").assignCategory("Parts Package").pass("Package add");
			test=test.createNode(Scenario.class, "Adding Package in old parts page");
			loginfo=test.createNode(new GherkinKeyword("Given"),"User will go to parts page and search for a partno");
	...
	public void user_wll_click_on_Package_and_select_Package_UOM_dropdown() throws Throwable {
		try {
			loginfo=test.createNode(new GherkinKeyword("When"),"User will click on Package and select Package UOM dropdown");
			ppckg.Packageclick();
	...
	public void user_will_verify_the_reocrd_has_shown_in_the_below_grid() throws Throwable {
		try {
			loginfo=test.createNode(new GherkinKeyword("When"),"User will verify the reocrd has shown in the below grid");
			ppckg.Verify(pro.getProperty("Vryuom1"));
	...
	public void user_will_go_to_parts_page_and_search_for_partno() throws Throwable {
		try {
			//extent=setup();	
			test = extent.createTest(Feature.class, "PMT Parts Package Add, Edit and Delete").assignCategory("Parts Package").pass("Package Edit");
			test=test.createNode(Scenario.class, "Editing Package in old parts page");
			loginfo=test.createNode(new GherkinKeyword("Given"),"User will go to parts page and search for partno in Search box");
			 ppckg = new PartsPackage();
			 ppckg.partslanding();
			 ppckg.partsearch(pro.getProperty("partnoenter"));
			loginfo.pass(" PartNo search succesfully ");
	...
	public void user_will_verify_the_Edit_reocrd_has_shown_in_the_below_grid() throws Throwable {
		try {
			loginfo=test.createNode(new GherkinKeyword("Then"),"User will verify the reocrd has shown in the below grid");
			ppckg.Verify(pro.getProperty("Vryuom2"));
	...
	public void user_will_go_to_parts_page_and_search_for_the_partno() throws Throwable {
		try {
			//extent=setup();	
			test = extent.createTest(Feature.class, "PMT Parts Package Add, Edit and Delete").assignCategory("Parts Package").pass("Package Delete");
			test=test.createNode(Scenario.class, "Deleting  Package in old parts page");
			loginfo=test.createNode(new GherkinKeyword("Given"),"User will go to parts page and search for the partno");
			 ppckg = new PartsPackage();
			 ppckg.partslanding();
			 ppckg.partsearch(pro.getProperty("partnoenter"));
			loginfo.pass(" PartNo search succesfully ");
	...
	public void user_will_click_on_Package_and_Click_Delete_Button() throws Throwable {
		try {
			loginfo=test.createNode(new GherkinKeyword("When"),"User will click on Package and Click Delete Button Accept Alert");
			ppckg.Packageclick();
	...
	public void user_will_verify_the_reocrd_has_not_shown_in_the_below_grid() throws Throwable {
		try {
			loginfo=test.createNode(new GherkinKeyword("And"),"User will verify the reocrd has not shown in the below grid");
			ppckg.DeleteVerify();
