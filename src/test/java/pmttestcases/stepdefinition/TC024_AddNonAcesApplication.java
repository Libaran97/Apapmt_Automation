...
public class TC024_AddNonAcesApplication extends Baseclass {
	...
	public void user_will_click_on_Application_and_Click_add_button() throws Throwable {
		try {
			// extent=setup();
			test = extent.createTest(Feature.class, "PMT Application Page").assignCategory("NonAces Applicarion")
					.pass("NonAces Applicarion added");
	...
	public void user_will_click_on_Application_and_Click_add_Application() throws Throwable {
		try {
			...
			test = extent.createTest(Feature.class, "PMT Application Page")
					.assignCategory("NonAces All year Application").pass("NonAces All year Application added");
	...
	public void user_will_click_on_Application_and_add_Application() throws Throwable {
		try {
			// extent=setup();
			test = extent.createTest(Feature.class, "PMT Application Page")
					.assignCategory("NonAces Invalid year Application").pass("NonAces Invalid year Application added");
