...
public class TC013PartsListAll extends Baseclass {
	...
	public void user_will_click_on_parts_page_and_it_will_redirect_to_parts_page(int arg1) throws Throwable {
		try {
			//extent=setup();	
			test = extent.createTest(Feature.class, "PMT Parts ListAll and Dropped Part#").assignCategory("Parts Add").pass("category added thanks");
	...
	public void user_will_select_Description_Reason_NoApplicarion_and_click_search() throws Throwable {
		try {
			loginfo=test.createNode(new GherkinKeyword("When"),"User will select Description, Reason NoApplicarion and click search");
	...
	@When("^User will Verify the parts number$")
	...
	public void user_will_click_parts_page_and_click_listall_button() throws Throwable {
		try {
			//extent=setup();	
			test = extent.createTest(Feature.class, "PMT Parts ListAll and Dropped Part#").assignCategory("Edit Parts").pass("Edit Parts List all");
	...
	public void user_will_Select_Category_sub_category_part_description_Product_line_and_Clickj_search() throws Throwable {
		try {
			loginfo=test.createNode(new GherkinKeyword("When"),"User will Select Category, sub category, part description, Product line and Click search");
	...
	public void user_will_Vrify_page_redirect_to_Allinone_page_or_not() throws Throwable {
		try {
			loginfo=test.createNode(new GherkinKeyword("Then"),"User will Verify page redirect to Allinone page or not");
	...
	public void user_will_click_parts_button_and_click_listall_button() throws Throwable {
		try {
			//extent=setup();	
			test = extent.createTest(Feature.class, "PMT Parts ListAll and Dropped Part#").assignCategory("Delete parts").pass("Delete parts in List all page");
	...
	public void user_will_Click_parts_and_list_all_page() throws Throwable {
		try {
			//extent=setup();	
			test = extent.createTest(Feature.class, "PMT Parts ListAll and Dropped Part#").assignCategory("Duplicate the parts").pass("Duplicate the parts in List all page");
	...
	public void user_will_Click_parts_page_and_list_all_page_for_Copy_Appparts() throws Throwable {
		try {
			//extent=setup();	
			test = extent.createTest(Feature.class, "PMT Parts ListAll and Dropped Part#").assignCategory("Duplicate the Appparts").pass("Duplicate the Appparts in List all page");
			test=test.createNode(Scenario.class, "Duplicate the Appparts in List all page");
			loginfo=test.createNode(new GherkinKeyword("Given"),"User will Click parts page and list all page for Copy Appparts");
			eppom = new PartsListAll();
			eppom.clickonParts();
			eppom.clickonListAll();
			loginfo.pass("Parts and listall Page clicked Successfully");
	...
	public void user_will_Select_Dropdown_Category_sub_category_part_description_Product_line_and_Click_search_for_Copy_Appparts() throws Throwable {
		try {
			loginfo=test.createNode(new GherkinKeyword("When"),"User will Select Dropdown Category, sub category, part description, Product line and Click search for Copy Appparts");
			eppom.SelectCategory(pro.getProperty("categoryname"));
			//eppom.SelectSubCategory(pro.getProperty("subcategoryname"));
			//eppom.SelectPartsDescription(pro.getProperty("partdesc"));
			//eppom.SelectProductLine(pro.getProperty("linecode"));
	...
	public void user_will_select_Description_Reason_ACES_Unmapped_and_click_search() throws Throwable {
		try {
			loginfo=test.createNode(new GherkinKeyword("When"),"User will select Description, Reason ACES Unmapped and click search");
			eppom.SelectDescription(pro.getProperty("partdesc"));
	...
	@When("^User will Verify ACES Unmapped parts number$")
